...
class _complaint extends State<complaint> {
  ...
  void showerr(QuickAlertType quick){
    QuickAlert.show(
        context: context,
        text: 'Your complaint has been taken successfully',
        type:  quick);
  }
  var name =new TextEditingController();
  var phone =new TextEditingController();
  var address=new TextEditingController();
  var complaint=new TextEditingController();
  @override
                      ...
                      child: Padding(padding: EdgeInsets.fromLTRB(20, 120, 20, 0),
                          child: Form(
                            ...
                            child: Column(mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  SizedBox(height: 20,),
                                  Text('Here text your complaint!', style: TextStyle(fontSize: 30,
                                  ...
                                  TextFormField (
                                      ...
                                      decoration: InputDecoration(prefixIcon: Icon(Icons.add_box,color: Colors.white70,),
                                          labelText: "Text your complaint",labelStyle: TextStyle(color: Colors.white.withOpacity(0.9)),filled: true,floatingLabelBehavior: FloatingLabelBehavior.never,
                                          fillColor: Colors.white.withOpacity(0.3),border: OutlineInputBorder(borderRadius: BorderRadius.circular(30),
                                              borderSide: const BorderSide(width: 0,style: BorderStyle.none)))
                                  ),
                                  Container(
